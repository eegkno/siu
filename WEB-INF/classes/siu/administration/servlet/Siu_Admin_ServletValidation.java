...
public class Siu_Admin_ServletValidation extends HttpServlet
{
        private String url = "";
                ...
                throws IOException, ServletException
        {
        	...
        	String Id =           session.getId();
                ...
                ruser = buser.validateUser(parameters,user);

                String error = (String)ruser.getElement(6);
                System.out.println("ruser = " + error);

                if (error.equals("0"))
                   url = "/jsp/administration/common/Siu_Admin_JspMain.jsp";
                if (error.equals("1"))
                   url = "/jsp/administration/error/Siu_Admin_JspError.jsp?error=00057";
                if (error.equals("2"))
                   url = "/jsp/administration/error/Siu_Admin_JspError.jsp?error=00058";
                if (error.equals("3"))
