...
public class Siu_Admin_ServletUpdateModule extends HttpServlet
{
                ...
                throws IOException, ServletException
        {
               ...
               try
               {
               	      ...
               	      sql = "update siu_admin_module set mod_status='0' where mod_name!=\'Administracion\'";
                      mod.hacerInsert(sql);
                      ...
                      while(enu.hasMoreElements())
                          {
                	        ...
                	        String value = (String)enu.nextElement();
                                ...
                                if(!value.equals("enviar"))
                                {
                                        ...
                                        sql = "update siu_admin_module set mod_status=\'1\' where mod_id=\'"+value+"\'";
                ...
                if(r==0)
                                url = "/jsp/administration/error/Siu_Admin_JspError.jsp?error=00067";
                else
