...
<script language="JavaScript" >
	function reloadLanguage(lang)
	{
		...
		document.forma.action = "/siu/siu.administration.servlet.Siu_Admin_ServletAuth?lang=" + lang;
...
<form name="forma" method="post" id="forma" action="/siu/siu.administration.servlet.Siu_Admin_ServletValidateAuth">

<h1 align="center">
    <font size="5" face="Verdana,Arial, Helvetica, sans-serif">
          <%=labels.getElement("00014")%>
    </font>
</h1>
