...
<p class="eventos3"><%=labels.getElement("00005")%></p>
 <p><br>
</p>
 <p><br>
     <script>
...
level0_regular="/siu/images/level0_regular.gif"
level0_round="/siu/images/level0_round.gif"
level1_regular="/siu/images/level1_regular.gif"
level1_round="/siu/images/level1_round.gif"
level1_sub="/siu/images/level1_sub.gif"
level1_sub_round="/siu/images/level1_sub_round.gif"
level1_round2="/siu/images/level1_round2.gif"
level2_regular="/siu/images/level2_regular.gif"
level2_round="/siu/images/level2_round.gif"
...
//Menu 0
makeMenu('top','<%=labels.getElement("00006")%>')
	makeMenu('sub','<%=labels.getElement("00016")%>','/siu/siu.administration.servlet.Siu_Admin_ServletAddUser','central')
	makeMenu('sub','<%=labels.getElement("00007")%>')
	  makeMenu('sub2','<%=labels.getElement("00011")%>','/siu/siu.administration.servlet.Siu_Admin_ServletConsultUser?option=1','central')
	  makeMenu('sub2','<%=labels.getElement("00012")%>','/siu/siu.administration.servlet.Siu_Admin_ServletConsultUser?option=2','central')
	  makeMenu('sub2','<%=labels.getElement("00013")%>','/siu/siu.administration.servlet.Siu_Admin_ServletConsultUser?option=3','central')
	  makeMenu('sub2','<%=labels.getElement("00042")%>','/siu/siu.administration.servlet.Siu_Admin_ServletConsultUser?option=4','central')
	  makeMenu('sub2','<%=labels.getElement("00043")%>','/siu/siu.administration.servlet.Siu_Admin_ServletConsultUser?option=5','central')
          makeMenu('sub2','','','')
...
//Menu 2
makeMenu('top','<%=labels.getElement("00008")%>')
        makeMenu('sub','<%=labels.getElement("00016")%>','/siu/siu.administration.servlet.Siu_Admin_ServletAddModule','central')
        makeMenu('sub','<%=labels.getElement("00009")%>','/siu/siu.administration.servlet.Siu_Admin_ServletDeleteModule','central')
        makeMenu('sub','<%=labels.getElement("00047")%>','/siu/siu.administration.servlet.Siu_Admin_ServletConsultModule','central')
        makeMenu('sub','<%=labels.getElement("00068")%>','/siu/siu.administration.servlet.Siu_Admin_ServletAdmonModule','central')
...
//Menu 6
makeMenu('top','<%=labels.getElement("00017")%>','/siu/siu.administration.servlet.Siu_Admin_ServletDestroy','_top')
